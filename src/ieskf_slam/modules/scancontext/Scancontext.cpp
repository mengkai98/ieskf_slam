...
SCManager::SCManager(const std::string &config_file_path, const std::string &prefix)
    : ModuleBase(config_file_path, prefix, "Scan Context") {
    readParam("SC_DIST_THRES", SC_DIST_THRES, 0.13);
    print_table();
}
// } // namespace SC2